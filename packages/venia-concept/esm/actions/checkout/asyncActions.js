...
export const editOrder = section => async function thunk(dispatch) {
...
export const getShippingMethods = () => {
  return async function thunk(dispatch, getState) {
    ...
    try {
      ...
      dispatch(actions.getShippingMethods.receive(error)); // check if the guest cart has expired
...
export const submitPaymentMethodAndBillingAddress = payload => async function thunk(dispatch, getState) {
...
export const submitOrder = () => async function thunk(dispatch, getState) {
  ...
  try {
    ...
    dispatch(checkoutReceiptActions.setOrderInformation({
      id: response,
      billing_address
